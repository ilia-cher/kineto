...
class MemoryTraceLogger : public ActivityLogger {
 public:
  ...
  void handleRuntimeActivity(
      ...
      //const libkineto::TraceActivity& ext) override {
    //activities_.push_back(std::make_unique<RuntimeActivity>(activity, ext));
 ...
 private:
  ...
  std::vector<const TraceSpan*> traceSpanList_;
  std::vector<const TraceSpan*> iterationList_;
